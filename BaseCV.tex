...
& \footnotesize{Contributing to the open source mathematics package: Sage. Responsible for the implementation of a variety of Game Theoretic algorithms that will be included in a release of Sage in the near future. Areas of Game Theory that will be implemented include: Normal Form Games, Co-operative Games and Matching Games. This developed teamwork and communication skills by providing real experience of a research environment.}\\
\\
%------------------------------------------------
