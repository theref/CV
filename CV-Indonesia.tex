...
\textsc{Jul. 2016} & \footnotesize{Worked at the UK's leading car insurance provider withing the Pricing department. This involved a lot of complex analysis work using large data sets to provide better understanding in business decisions.}\\
\\
%------------------------------------------------
\textsc{Summer} & Research Internship, Cardiff University School of Mathematics \\
\textsc{2015}& \footnotesize{Employed for the Summer to lead a project using code I had previously written to asses the affect of selfish behaviour by hospitals on the expected waiting time for evergency vehicles \url{https://github.com/theref/sage-game-theory}} \\
\\
%------------------------------------------------
\textsc{Summer} & Research Internship, Cardiff University School of Mathematics \\
...
\\
%------------------------------------------------
\textsc{Sept. 2009 -} & Leader at 1\textsuperscript{st} Helsby Scouts\\
\textsc{Current}& \footnotesize{Developed communication skills whilst helping to supervise and teach children aged 6 - 10 years.
...
\begin{itemize}
    ...
    \item Programming: SAS, Python, Django, Ruby, Git, Trac and well evidenced ability to gain proficiency in new languages quickly.
\end{itemize}
...
\\
At University, I took up the sport of Ultimate Frisbee. I was elected to serve as treasurer for a year and have represented the univeristy on several occasions. \\
\\
